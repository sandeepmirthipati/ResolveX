          ...
          <Card className="p-5">
            ...
            <div className="space-y-2.5 text-xs">
              {[
                ...
                { label: 'Assigned To', value: complaint.assigned_to_name || 'Unassigned' },
                { label: 'Assigned By', value: complaint.assigned_by_name || '—' },
                { label: 'Assigned At', value: complaint.assigned_at ? formatDateTime(complaint.assigned_at) : '—' },
